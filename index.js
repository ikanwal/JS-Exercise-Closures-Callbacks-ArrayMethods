...
function processSum(numberList,callback) {
  /* CODE HERE */
return callback(numberList.reduce(function(value,curr_val){
...
function processDuplicateFree(list,callback) {
  return callback([... new Set(list)]);  //square set operator
}
...
function tallyUpDonations(runners) {
  /* CODE HERE */
  return runners.reduce(function(sum,curr_val){
    return sum+curr_val.donation;
  },0)
}
